...
// +s QCT_BT_PATCH_SR00698908 suhui.kim@lge.com 111226, fix the issue that do not output the A2DP sound after trying OPP transfer to LG HBS-200 Headset.
// Audio driver release only if all audio uuids removed in sdp.
...
// +s LG_BT_BLUEZ_OOB hseok.kim@lge.com
#if defined(LG_BT_BLUEZ_OOB)
